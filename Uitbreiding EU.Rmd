...
numAFvehicles <- read_xlsx("Total number AF vehicles.xlsx", skip = 2 , col_types = c("text", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric"))
...
```{r}
pevchargingpoint <- read_xlsx("PEV's per public charging point.xlsx", skip = 2 , col_types = c("text", "numeric", "numeric"))
...
```{r}
growthAFvehiclesfeet <- read_xlsx("Growth AF vehicles fleet.xlsx", skip = 2 , col_types = c("text", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric"))
...
```{r}
growthAFinfrastructure <- read_xlsx("Growth AF infrastructure.xlsx", skip = 2 , col_types = c("text", "numeric", "numeric", "numeric", "numeric", "numeric"))
...
```{r}
fastpublicchargingpoint <- read_xlsx("Fast public charging points per 100 km highway.xlsx", skip = 2 , col_types = c("text", "numeric", "numeric"))
