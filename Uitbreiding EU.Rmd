...
numAFvehicles <- read_xlsx("C:/Users/Lien/Documents/Unief 2/1e Master/Business intelligence/Project/Uitbreiding EU/Total number AF vehicles.xlsx", skip = 2 , col_types = c("text", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric"))
...
```{r}
numAFinfrastructure <- read_xlsx("C:/Users/Lien/Documents/Unief 2/1e Master/Business intelligence/Project/Uitbreiding EU/Total number AF infrastructure.xlsx", skip = 2 , col_types = c("text", "numeric", "numeric", "numeric", "numeric", "numeric"))
...
```{r}
pevchargingpoint <- read_xlsx("C:/Users/Lien/Documents/Unief 2/1e Master/Business intelligence/Project/Uitbreiding EU/PEV's per public charging point.xlsx", skip = 2 , col_types = c("text", "numeric", "numeric"))
...
```{r}
growthAFvehiclesfeet <- read_xlsx("C:/Users/Lien/Documents/Unief 2/1e Master/Business intelligence/Project/Uitbreiding EU/Growth AF vehicles fleet.xlsx", skip = 2 , col_types = c("text", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric"))
...
```{r}
growthAFinfrastructure <- read_xlsx("C:/Users/Lien/Documents/Unief 2/1e Master/Business intelligence/Project/Uitbreiding EU/Growth AF infrastructure.xlsx", skip = 2 , col_types = c("text", "numeric", "numeric", "numeric", "numeric", "numeric"))
...
```{r}
fastpublicchargingpoint <- read_xlsx("C:/Users/Lien/Documents/Unief 2/1e Master/Business intelligence/Project/Uitbreiding EU/Fast public charging points per 100 km highway.xlsx", skip = 2 , col_types = c("text", "numeric", "numeric"))
